...
class TrnBase(object):
    ...
    def setup_optimizer(self):
        ...
        # self.logger.log(logging.LTRN, f"[optimizer]: {self.optimizer.param_groups}")
        self.logger.log(logging.LTRN, f"[optimizer]: {self.optimizer.__class__.__name__}, {self.criterion.__class__.__name__}")
